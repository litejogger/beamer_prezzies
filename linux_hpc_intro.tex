...
\begin{frame}{What Is Linux?}
  \begin{columns}[T]
    \column{0.52\textwidth}
      {\small The \textbf{kernel} is the core of the operating system ---
      ...
      \begin{block}{The software stack}
        \small\textbf{Hardware} $\to$ \textbf{Linux Kernel} $\to$ \textbf{Bash Shell} $\to$ \textbf{Your Code}
      \end{block}

    \column{0.44\textwidth}
      \begin{block}{On Henry2}
        \small When you SSH into the cluster, you land in a bash shell.
